...
(function() {
    ...
    b.destroy = function() {
        if (this.element)
            this.element.ontouchstart = function() {}, this.element.onmousedown = function() {}, this.parent && this.parent.element && this.parent.element.removeChild(this.element);
